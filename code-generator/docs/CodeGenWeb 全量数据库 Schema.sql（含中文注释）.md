...
CREATE TABLE gen_history (
    ...
    template_set TEXT NOT NULL COMMENT '使用的模板集合，JSON格式，如：{"vue-list":"vue-list.vue.ftl","ts-api":"api.ts.ftl"}',
