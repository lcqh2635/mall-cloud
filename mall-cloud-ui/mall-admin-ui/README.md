# 🚀 mall-admin-ui — 用 Tauri 2.0 + Bun + TypeScript 构建现代桌面应用
...
🔗 项目地址：[https://github.com/lcqh2635/mall-admin-ui](https://github.com/lcqh2635/mall-admin-ui)

---

## 🌟 项目简介

`mall-admin-ui` 是一个基于 **Tauri 2.0** 的桌面应用模板，采用 **Bun** 作为运行时和包管理器，结合 **TypeScript** 实现前后端一体化开发。该项目旨在提供一个轻量、高效、现代化的技术栈组合，帮助开发者快速构建安全、跨平台的桌面应用。
