package com.mallcloud.commons.api.services.promotion;
...
public interface PromotionServiceClient {
    ...
    String getData(@PathVariable String owner, @PathVariable String repo);

    @PostExchange("/repos/{owner}/{repo}/contributors")
    String addData(@PathVariable String owner, @PathVariable String repo);

    @PutExchange("/repos/{owner}/{repo}/contributors")
    String updateData(@PathVariable String owner, @PathVariable String repo);

    @DeleteExchange("/repos/{owner}/{repo}/contributors")
    String deleteData(@PathVariable String owner, @PathVariable String repo);
